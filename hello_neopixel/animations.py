...
def run_animations(
    ...
    Args:
        ...
        write_kwargs (dict, optional): any additional parameters to pass into
                                       the write() functions of the LED
                                       strips. Primarily to be used for testing.
    ...
    for animation in animations:
        light_strips = light_strips | animation.light_strips
    ...
    try:
        while True:
            ...
            for light_strip in light_strips:
                light_strip.write(**write_kwargs)
